...
import { getDevAccount, getProvider, sendStrksFromSnAccount, SERVER } from "../utils";
...
describe('Using ethers.js with Rosettanet RPC', () => {
    ...
    test.only('Send tx from undeployed account. Tx must fail but account has to be deployed', async () => {
        ...
        const privateKey = '0x9979f9c93cbca19e905a21ce4d6ee9233948bcfe67d95c11de664ebe4b78c506'; // Different address
        ...
        const accountClass = await starknetProvider.getClassHashAt(precalculatedSnAddress);
    ...
    test.only('Send tx wrongly signed tx', async () => {
        const malformedSignedTx = ''

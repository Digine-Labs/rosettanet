...
import { EVMDecodeError, EVMDecodeResult, EVMEncodeResult, PrepareCalldataError, RosettanetSignature, RPCError, RPCResponse, SignedRawTransaction, StarknetContract, StarknetRPCError, ValidationError } from "./types";
...
export function isSignedRawTransaction(value: unknown): value is SignedRawTransaction {
    ...
    if (typeof value === "object" && value !== null) {
        ...
        && typeof obj.gasLimit === 'bigint' && (typeof obj.maxFeePerGas === 'bigint' || obj.gasPrice != null) && (typeof obj.maxPriorityFeePerGas === 'bigint' || obj.gasPrice != null);
    }
    return false; 
}
...
export function isPrepareCalldataError(value: unknown): value is PrepareCalldataError {
    if (typeof value === "object" && value !== null) {
